...
#define FDTD_REG_SAMPlE_ADDR        ( USER_PLUGIN_AXI_BASE_ADDR + 0x20 )
//
#define FDTD_REG_SIZE               ( USER_PLUGIN_AXI_BASE_ADDR + 0x24 )
#define FDTD_REG_CTRL               ( USER_PLUGIN_AXI_BASE_ADDR + 0x28 )
#define FDTD_REG_CMD                ( USER_PLUGIN_AXI_BASE_ADDR + 0x2C )
#define FDTD_REG_STATUS             ( USER_PLUGIN_AXI_BASE_ADDR + 0x30 )
#define FDTD_REG_START_CALC_SIGNAL  ( USER_PLUGIN_AXI_BASE_ADDR + 0x34 )


#define FDTD_REG_HY_ADDR            ( USER_PLUGIN_AXI_BASE_ADDR + 0x38 )
#define FDTD_REG_EZ_ADDR            ( USER_PLUGIN_AXI_BASE_ADDR + 0x3C )
#define FDTD_REG_BUFFER_SIZE        ( USER_PLUGIN_AXI_BASE_ADDR + 0x40 )
#define FDTD_REG_BUFFER_STATUS      ( USER_PLUGIN_AXI_BASE_ADDR + 0x44 )
#define FDTD_CALC_HY_SGL	    ( USER_PLUGIN_AXI_BASE_ADDR + 0x48 )
#define FDTD_CALC_EZ_SGL	    ( USER_PLUGIN_AXI_BASE_ADDR + 0x4C )
#define FDTD_CALC_SRC_SGL	    ( USER_PLUGIN_AXI_BASE_ADDR + 0x50 )
#define FDTD_REG_UPDATE_END_SGL     ( USER_PLUGIN_AXI_BASE_ADDR + 0x54 )
#define FDTD_REG_CALC_STATUS        ( USER_PLUGIN_AXI_BASE_ADDR + 0x58 )
...
#define FDTD_SAMPLE       	 REG(FDTD_REG_SAMPlE_ADDR )
#define FDTD_START_CALC_SIGNAL   REG(FDTD_REG_START_CALC_SIGNAL)
#define HY_ADDR		         REG(FDTD_REG_HY_ADDR     )
#define EZ_ADDR		         REG(FDTD_REG_EZ_ADDR     )
#define REG_BUFFER_SIZE	         REG(FDTD_REG_BUFFER_SIZE )
#define BUFFER_STATUS            REG(FDTD_REG_BUFFER_STATUS)
#define CALC_HY_SGL		 REG(FDTD_CALC_HY_SGL     )
#define CALC_EZ_SGL		 REG(FDTD_CALC_EZ_SGL     )
#define CALC_SRC_SGL		 REG(FDTD_CALC_SRC_SGL    )
#define FIELD_UPDATE_END_SGL     REG(FDTD_REG_UPDATE_END_SGL)
#define FDTD_CALC_STATUS         REG(FDTD_REG_CALC_STATUS)
