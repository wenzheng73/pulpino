...
#define FDTD_HY_ADDR		         REG( FDTD_REG_HY_ADDR        )
#define FDTD_EZ_ADDR		         REG( FDTD_REG_EZ_ADDR        )
#define FDTD_CALC_HY_SGL		     REG( FDTD_REG_CALC_HY_SGL    )
#define FDTD_CALC_EZ_SGL		     REG( FDTD_REG_CALC_EZ_SGL    )
#define FDTD_CALC_SRC_SGL		     REG( FDTD_REG_CALC_SRC_SGL   )
//
